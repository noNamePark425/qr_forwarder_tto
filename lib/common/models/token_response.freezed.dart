...
class _$TokenResponseImpl implements _TokenResponse {
  const _$TokenResponseImpl({required this.status, required this.result});
  ...
  @override
  String toString() {
    return 'TokenResponse(status: $status, result: $result)';
  }
...
abstract class _TokenResponse implements TokenResponse {
  const factory _TokenResponse(
      ...
      required final String result}) = _$TokenResponseImpl;
